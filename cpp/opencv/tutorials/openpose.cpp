...
int main(int argc, char** argv)
{
	...
	String modelBin = sampels::findFile(parser.get<string>("model"));
	...
	{
		cout << "A sample app to demonstrate human or hand pose detection with a pretrained OpenPose dnn.\n";
		parser.printMessage();
		return 0;
	}
	...
	// find the position of the body part
